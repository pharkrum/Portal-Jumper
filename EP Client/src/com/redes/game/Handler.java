...
import com.redes.game.entity.mob.Mine;
	...
	public void createLevel(BufferedImage level){
		...
		for(int y=0; y<height;y++){
			for(int x=0; x<width; x++){
				...
				if (red==0 && green==0 && blue==255) addEntity(new Player(0,0,64,64,Id.player1,this));
				if (red==0 && green==255 && blue==0) addEntity(new Player(x*64,y*64,64,64,Id.player2,this));
				...
				if (red==255 && green==0 && blue ==0) addEntity(new Mine(x*64,y*64,64,64,Id.mine,this));
